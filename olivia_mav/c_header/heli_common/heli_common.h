/** @file
 *	@brief MAVLink comm protocol generated from heli_common.xml
 *	@see http://mavlink.org
 */
#ifndef MAVLINK_HELI_COMMON_H
#define MAVLINK_HELI_COMMON_H

#ifndef MAVLINK_H
    #error Wrong include order: MAVLINK_HELI_COMMON.H MUST NOT BE DIRECTLY USED. Include mavlink.h from the same directory instead or set ALL AND EVERY defines from MAVLINK.H manually accordingly, including the #define MAVLINK_H call.
#endif
...
#include "./mavlink_msg_rotor_angle.h"

#ifdef __cplusplus
}
#endif // __cplusplus
#endif // MAVLINK_HELI_COMMON_H
