/** @file
 *	@brief MAVLink comm protocol testsuite generated from heli_common.xml
 *	@see http://qgroundcontrol.org/mavlink/
 */
#ifndef HELI_COMMON_TESTSUITE_H
#define HELI_COMMON_TESTSUITE_H
...
static void mavlink_test_heli_common(uint8_t, uint8_t, mavlink_message_t *last_msg);

static void mavlink_test_all(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{

	mavlink_test_heli_common(system_id, component_id, last_msg);
}
#endif
...
static void mavlink_test_rotor_angle(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_rotor_angle_t packet_in = {
		17.0,45.0,73.0
    };
	mavlink_rotor_angle_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.yaw = packet_in.yaw;
        	packet1.roll = packet_in.roll;
        	packet1.pitch = packet_in.pitch;
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_rotor_angle_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_rotor_angle_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_rotor_angle_pack(system_id, component_id, &msg , packet1.yaw , packet1.roll , packet1.pitch );
	mavlink_msg_rotor_angle_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_rotor_angle_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.yaw , packet1.roll , packet1.pitch );
	mavlink_msg_rotor_angle_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_rotor_angle_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_rotor_angle_send(MAVLINK_COMM_1 , packet1.yaw , packet1.roll , packet1.pitch );
	mavlink_msg_rotor_angle_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_heli_common(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_test_rotor_angle(system_id, component_id, last_msg);
}

#ifdef __cplusplus
}
#endif // __cplusplus
#endif // HELI_COMMON_TESTSUITE_H
